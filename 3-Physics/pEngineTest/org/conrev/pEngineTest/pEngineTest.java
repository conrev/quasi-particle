...
package org.conrev.pEngineTest;
...
import org.conrev.pEngine.Body;
import org.conrev.pEngine.Circle;
import org.conrev.pEngine.ImpulseMath;
import org.conrev.pEngine.ImpulseScene;
import org.conrev.pEngine.Manifold;
import org.conrev.pEngine.Polygon;
import org.conrev.pEngine.Vec2;
...
public class pEngineTest implements Game
{

	public static void main( String[] args )
	{
		Game game = new pEngineTest();
		GameLoop loop = new GameLoopVariable( 0.1f );
		GameScreen screen = new GameScreen( 640, 480, true, loop, game );
		screen.setBackground( Color.black );
		GameScreen.showWindow( screen, "pEngine-Java" );
	}
